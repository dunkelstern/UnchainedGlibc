# 1 "/usr/include/monetary.h"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/usr/include/monetary.h" 2
# 22 "/usr/include/monetary.h"
